...
export const api_options = {
  ...
  headers: {
    ...
    Authorization: "Bearer " + import.meta.VITE_REACT_APP_TMDB_KEY
  }
};

export const gemini_api_key = import.meta.env.VITE_REACT_APP_AI_KEY;
// export const gemini_api_key = "AIzaSyCYp_HaNTIWTBGsht_1XiKUUcTPzFnt_Fc";
